...
import { connectors } from "@/connectors/offchainSessionConnectors";
...
export default function OffchainSession() {
  ...
  return (
    <main className="flex min-h-screen flex-col p-24 gap-4">
      ...
      <div>
        {!connectedWallet && (
          <ConnectButton connectors={connectors} setConnectedWallet={setConnectedWallet} setChainId={setChainId} />
        )}
      </div>
